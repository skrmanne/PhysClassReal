...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TRAIN.DATA.DATASET == "COHFLOW":
            train_loader = data_loader.COHFlowLoader.COHFlowLoader
        ...
        elif config.TRAIN.DATA.DATASET == "AIRFLOW":
            train_loader = data_loader.AIRFLOWLoader.AIRFLOWLoader
        else:
        ...
        elif config.VALID.DATA.DATASET == "COHFLOW":
            valid_loader = data_loader.COHFlowLoader.COHFlowLoader
        ...
        elif config.VALID.DATA.DATASET == "AIRFLOW":
            valid_loader = data_loader.AIRFLOWLoader.AIRFLOWLoader
        ...
        elif config.TEST.DATA.DATASET == "COHFLOW":
            test_loader = data_loader.COHFlowLoader.COHFlowLoader
        ...
        elif config.TEST.DATA.DATASET == "AIRFLOW":
            test_loader = data_loader.AIRFLOWLoader.AIRFLOWLoader
        else:
